...
(function () {
  ...
  function makeLabels() {
    ...
    .attr('id', 'title')
      ...
      .text("Life Expectancy vs Fertility - " + selectedYear);
    ...
    circles = svgContainer.selectAll('.dot')
      ...
      .on("mouseover", (d) => {
        div.transition()
          .duration(200)
          .style("opacity", .9);
        div.html("Location: " + d.location + "<br/>" + "Population: " + numberWithCommas(d["pop_mlns"]*1000000) + "<br/>" + "Year: " + d.time + "<br/>" + "Life Expectancy: " + d.life_expectancy + "<br/>" + "Fertility: " + d.fertility_rate)
